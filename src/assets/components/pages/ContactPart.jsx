      ...
      <section id="contact">
        ...
        <Container className={"py-[40px]"}>
          <div className="text-center">
            ...
            <p className="font-Ovo text-[20px] text-[#565656] w-[577px] m-auto">
          ...
          <div className="text-center mt-[40px]">
            <form action="">
              <div className="flex justify-center gap-x-[40px] mb-[40px]">
              ...
              <textarea placeholder="Enter your message" className="rounded-[8px] w-[722px] h-[200px] border-2 border-[#A4A4A4] p-5 focus:outline-0 placeholder:font-Outfit placeholder:text-[#B3B3B3]"></textarea>
              <br />
